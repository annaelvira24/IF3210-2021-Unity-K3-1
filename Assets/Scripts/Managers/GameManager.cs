...
public class GameManager : MonoBehaviour
{
    ...
    {
        // ... create them, set their player number and references needed for control.
        if (m_Tanks[m_PlayerNow - 1].m_Instance.GetComponent<TankCash>().cashAmount >= 6) 
        {
            ...
            m_Bot1Count++;
            m_Tanks[m_PlayerNow - 1].m_Instance.GetComponent<TankCash>().cashAmount -= 6;
            m_Tanks[m_PlayerNow - 1].m_Instance.GetComponent<TankCash>().cashText.GetComponent<Text>().text = ": " + m_Tanks[m_PlayerNow - 1].m_Instance.GetComponent<TankCash>().cashAmount;
        }
    ...
    {
        if (m_Tanks[m_PlayerNow - 1].m_Instance.GetComponent<TankCash>().cashAmount >= 3)
        {
            int count = 0;
            ...
            m_Tanks[m_PlayerNow - 1].m_Instance.GetComponent<TankCash>().cashAmount -= 3;
            m_Tanks[m_PlayerNow - 1].m_Instance.GetComponent<TankCash>().cashText.GetComponent<Text>().text = ": " + m_Tanks[m_PlayerNow - 1].m_Instance.GetComponent<TankCash>().cashAmount;
        }
    }
